    ...
    return (
        <>
            ...
            <div className="max-w-4xl mx-auto animate-fadeIn">
                <h1 className="text-4xl font-bold mb-2 text-primary-text">Color Utilities Suite</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="space-y-8 animate-slideInLeft">
                        <Card className="p-8">
                            <h2 className="text-2xl font-bold mb-4 text-primary-text">WCAG Contrast Checker</h2>
                        ...
                        <Card className="p-8">
                            <h2 className="text-2xl font-bold mb-4 text-primary-text">Color Blindness Simulator</h2>
                            <div>
                    ...
                    <div className="animate-slideInRight">
                        <Card className="p-8 sticky top-28">
                            <h2 className="text-2xl font-bold mb-4 text-primary-text">Palette Builder</h2>
